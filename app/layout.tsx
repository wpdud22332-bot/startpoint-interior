      ...
      <body className="min-h-screen bg-gray-50 text-gray-900 antialiased">
        ...
        <header className="sticky top-0 z-40 w-full border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3">
            ...
            <nav className="hidden items-center gap-6 text-sm text-gray-600 md:flex">
              ...
              <a href="#portfolio" className="hover:text-emerald-600">
                포트폴리오
              </a>
              <a href="#process" className="hover:text-emerald-600">
                프로세스
              </a>
              <a href="#reviews" className="hover:text-emerald-600">
                후기
              </a>
        ...
        <footer className="mt-20 border-t bg-white">
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-5 py-10 md:grid-cols-3">
            <div>
              ...
              <p className="text-sm text-gray-600">
                공간의 가치를 설계하는 파트너. 주거/상업 리모델링, 브랜딩 인테리어
                전문.
              </p>
            </div>
          ...
          <div className="border-t bg-gray-50">
            <div className="mx-auto max-w-7xl px-5 py-4 text-center text-xs text-gray-500">
              © {new Date().getFullYear()} 스타트포인트 인테리어. All rights reserved.
            </div>
          </div>
        </footer>
      </body>
